...
async def start_yukki():
    ...
    if ekish:
        ...
        try:
            ...
            await shi(functions.channels.JoinChannelRequest(channel="@mr_sukkun "))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if baish:
        ...
        try:
            ...
            await yaa(functions.channels.JoinChannelRequest(channel="@mr_sukkun "))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if teish:
        ...
        try:
            ...
            await dav(functions.channels.JoinChannelRequest(channel="@mr_sukkun "))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if tfour:
        ...
        try:
            ...
            await raj(functions.channels.JoinChannelRequest(channel="@mr_sukkun "))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if tfive:
        ...
        try:
            ...
            await put(functions.channels.JoinChannelRequest(channel="@mr_sukkun "))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
...
async def get_users(event):
    if event.sender_id in SMEX_USERS:
        ...
        await krishna.edit(
            "**⚜️[ᴛᴇʀᴍɪɴᴀʟ sᴛᴀᴛᴜs](https://t.me/worldwide_friend_zone)**\n\n`🔸Inviting Users.......`"
        )
...
text = """
CONGRATS 🥳🥳🥳 & SAY THANKS TO Mukesh (@itz_mst_boy)
"""
